...
// Unit Test #1
    // Printing the first set of lyrics to the console
        ...
        // Unit Test #2
    // Printing the second set of lyrics to the console with some blank lines
        Console.WriteLine("\nOh-oh-oh-oh-oh,");
        Console.WriteLine("");
        ...
        // Unit Test #3
    // Printing the third set of lyrics to the console
        ...
        // Unit Test #4
    // Printing the fourth set of lyrics to the console
